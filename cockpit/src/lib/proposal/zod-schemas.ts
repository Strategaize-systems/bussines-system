...
// V5.7 SLC-571 (DEC-122/128): Whitelist um NL-Saetze 9% + 21% erweitert. Legacy
// 19% bleibt fuer existierende DE-Angebote gueltig (Snapshot-Prinzip DEC-107).

export const PROPOSAL_TAX_RATES = [0, 7, 9, 19, 21] as const;
