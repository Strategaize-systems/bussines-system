...
export async function updateSession(request: NextRequest) {
  ...
  const publicPaths = ["/login", "/auth/callback", "/auth/set-password", "/api/cron", "/api/webhooks", "/consent", "/api/track", "/api/export", "/api/branding", "/r/", "/api/leads/intake", "/api/campaigns", "/api/winloss", "/datenschutz", "/impressum"];
