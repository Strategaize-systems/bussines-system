...
- Current Phase: V7 Multi-User + Teamlead-Sprint — **7/7 Slices done + Gesamt-/qa PASS + Live-Smoke PASS + /final-check PASS + BL-467 (SMTP) + BL-470 (Invite-Flow) done + Invite-Live-Smoke PASS**. **Release-Ready.** Offene V7.1-Items: BL-466 (Defense-in-Depth-Polish), BL-468 (Drilldown-Pipeline-Erweiterung), BL-469 (Settings-Rollen-Permissions) — Entscheidung User: V7 jetzt deployen + V7.1 als naechster Sprint vs. V7.1 vorziehen.
