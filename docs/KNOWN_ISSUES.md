...
- Next Action: Entscheiden (DEC): entweder Tracking-Pixel-/Remote-Image-Block als bewusst dokumentieren (mit UI-Hinweis "Bilder blockiert"), ODER `img-src https:` gezielt für den Viewer-Kontext erlauben (eigene CSP via Route/Proxy statt globaler Lockerung). Fix-Slice: BL-520.
