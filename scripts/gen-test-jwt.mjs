#!/usr/bin/env node
// SLC-412 MT-5: Zero-dep JWT-Generator fuer Jitsi-Smoke-Test.
// Erzeugt HS256-Token fuer einen Jitsi-Raum. Nicht fuer Produktion —
// Prod-JWT wird in SLC-414 ueber /lib/meetings gebaut.
//
// Usage:
//   JITSI_JWT_APP_SECRET=<secret> node scripts/gen-test-jwt.mjs [room]
//
...
const appId = process.env.JITSI_JWT_APP_ID || "business";
const domain = process.env.JITSI_DOMAIN || "meet.strategaizetransition.com";
